package app.views
{
	...
	public class DropDownItemSmallRendererSmall extends LayoutGroupListItemRenderer implements IListItemRenderer
	{
		...
		public function DropDownItemSmallRendererSmall()
		{
			super();
		}
		...
		override protected function initialize():void
		{
			...
			_label = Factory.label(Fonts.FONT_LIGHT, 24, 0x000000, TextFormatAlign.LEFT, false, 0);
			addChild(_label);
